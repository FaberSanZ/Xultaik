...
<img src="Screenshots/DynamicUniformBuffer.PNG" width=350> | [DynamicUniformBuffer](Src/Samples/Samples/DynamicUniformBuffer.cs)<br> This example use dynamic uniform buffers are used for rendering multiple objects with multiple matrices stored in a single uniform buffer object. Individual matrices are dynamically addressed upon descriptor binding time, minimizing the number of required descriptor sets..
