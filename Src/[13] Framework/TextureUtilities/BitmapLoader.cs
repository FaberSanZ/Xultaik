...
namespace _13__Framework
{
    public class BitmapLoader
    {
        ...
        // Methods.
        public void Initialize(Device device, string fileName)
        {
        ...
        public Texture2D CreateTexture2DFromBitmap(Device device, BitmapSource bitmapSource)
        {
            ...
            DataStream s = new DataStream(bitmapSource.Size.Height * bitmapSource.Size.Width * 4, true, true);
            bitmapSource.CopyPixels(bitmapSource.Size.Width * 4, s);

            DataRectangle rect = new DataRectangle(s.DataPointer, bitmapSource.Size.Width * 4);
