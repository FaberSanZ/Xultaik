...
namespace Graphics
{
    public class ResourceInfo
    {
        ...
        public CpuAccessFlags AccessFlag { get; set; }
        public ResourceUsage UsageType { get; set; }
        ...
        public static ResourceInfo ConstantBuffer => new ResourceInfo(BindFlags.ConstantBuffer, CpuAccessFlags.None, ResourceUsage.Default);
