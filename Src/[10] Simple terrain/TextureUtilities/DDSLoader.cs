...
namespace _10__Simple_terrain
{
    ...
    public static class DDSLoader
    {
        ...
        public static ShaderResourceView LoadTextureFromFile(Device device, DeviceContext deviceContext, string filename)
        {
            ...
            {
                bool isCube;
                return CreateTextureFromDDS(device, deviceContext, System.IO.File.ReadAllBytes(filename), out isCube);
            }
            else
            {
                return CreateTextureFromBitmap(device, deviceContext, filename);
            }
        }
    }
}
