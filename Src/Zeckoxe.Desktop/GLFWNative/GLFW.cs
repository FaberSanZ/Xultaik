...
namespace Zeckoxe.Desktop.GLFWNative
{
    internal static unsafe partial class GLFW
    {
		...
		internal delegate IntPtr glfwGetX11Window(IntPtr window);
		private static readonly glfwGetX11Window glfwGetX11Window_ = GLFWLoader.GetStaticProc<glfwGetX11Window>("glfwGetX11Window");
		internal static IntPtr GlfwGetX11Window(IntPtr window) => glfwGetX11Window_(window);


		internal delegate IntPtr glfwGetX11Display();
		private static readonly glfwGetX11Display glfwGetX11Display_ = GLFWLoader.GetStaticProc<glfwGetX11Display>("glfwGetX11Display");
		internal static IntPtr GlfwGetX11Display() => glfwGetX11Display_();
		...
		internal delegate IntPtr glfwGetWaylandWindow(IntPtr window);
		private static readonly glfwGetWaylandWindow glfwGetWaylandWindow_ = GLFWLoader.GetStaticProc<glfwGetWaylandWindow>("glfwGetWaylandWindow");
		internal static IntPtr GlfwGetWaylandWindow(IntPtr window) => glfwGetWaylandWindow_(window);


		internal delegate IntPtr glfwGetWaylandDisplay();
		private static readonly glfwGetWaylandDisplay glfwGetWaylandDisplay_ = GLFWLoader.GetStaticProc<glfwGetWaylandDisplay>("glfwGetWaylandDisplay");
