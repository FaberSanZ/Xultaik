...
namespace Zeckoxe.Image
{
    public class WICLoader
    {
        ...
        public WICLoader(string filename, int mipMaps = 1)
        {
            ...
            int bitsPerPixel = GetBitsPerPixel(TextureData.Format);

            int rowPitch = (TextureData.Width * bitsPerPixel) / 8;
            int imagesize = rowPitch * TextureData.Height;
            ...
            TextureData.Size = (imagesize / rowPitch) / bitsPerPixel; // TODO: 
        ...
        public static TextureData LoadFromFile(string filename, int mipMaps = 1) => new WICLoader(filename, mipMaps).TextureData;
