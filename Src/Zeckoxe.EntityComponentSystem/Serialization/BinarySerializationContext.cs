using System;
using Zeckoxe.EntityComponentSystem.Technical.Serialization;
using Zeckoxe.EntityComponentSystem.Technical.Serialization.BinarySerializer;
using Zeckoxe.EntityComponentSystem.Technical.Serialization.BinarySerializer.ConverterAction;

namespace Zeckoxe.EntityComponentSystem.Serialization
{
    /// <summary>
